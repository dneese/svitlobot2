...
void handleHelp() { 
  ...
  html += "<p>Цей пристрій на базі ESP32 svitlobot_esp32_2.9  21.11.2025 призначений для відстеження наявності світла (або інтернету) та надсилання регулярних сигналів (пінгів) на сервіси:</p>";
  html += "<ul>";
